    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          Container(
            width: 160,
            color: const Color.fromARGB(255, 210, 52, 40),
          ),
          Container(
            width: 160,
            color: const Color.fromARGB(255, 0, 237, 47),
          ),
          Container(
            width: 160,
            color: const Color.fromARGB(255, 7, 131, 232),
          ),
          Container(
            width: 160,
            color: const Color.fromARGB(255, 5, 198, 21),
          ),
          Container(
            width: 160,
            color: Colors.orange,
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Container(
                color: const Color.fromARGB(255, 243, 33, 212),
                child: Center(
                  child: Text(
                    'Expanded Header',
                    style: TextStyle(
